			...
			<table class="table table-striped"
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><%=vo.getBbsTitle()%></td>
					</tr>
					<tr>
						<td>작성자</td>
					...
					<tr>
						<td>작성일</td>
						<td colspan="2"><%=vo.getBbsDate().substring(0, 11) + vo.getBbsDate().substring(11, 13) + "시"
					+ vo.getBbsDate().substring(14, 16) + "분"%></td>
					</tr>
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%=vo.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
					.replaceAll("\n", "<br/>")%></td>
